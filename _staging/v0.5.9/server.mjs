...
acquireInstanceLock();process.on('exit',releaseInstanceLock);
...
let historyStats = handoff.role === 'LAPTOP' ? new Map() : loadHistoryStats(db, Date.now(), config.historyIntervalSeconds);
